...
<html lang="en">
    ...
    <link href="{{ asset('dashboard') }}/frontend/bootstrap.min.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <div class="col-lg-12 login-form">
                    <div class="col-lg-12 login-form">
                        <form method="POST" action="{{ route('develop.login') }}">
                            @method('POST')
                            @csrf
        ...
        <script src="{{ asset('dashboard/admin/js/jquery-2.2.4.min.js') }}"></script>
