                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ old('email') }}" placeholder="Email Id" required
                                    autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="tel" class="form-control @error('mobile') is-invalid @enderror"
                                    name="mobile" value="{{old('mobile')}}" placeholder="11 digit Mobile number"
                                    minlength=11 maxlength=11 pattern="\d*" title="11 digit Mobile number" required>
                                @error('mobile')
