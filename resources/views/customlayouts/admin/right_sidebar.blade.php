        ...
        <div class="right-bar-inner">
            ...
            <div class="right-bar-content">
                ...
                <div class="box no-shadow box-bordered border-light">
                    ...
                    <div class="box-footer">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="my-0"><span class="badge badge-xl badge-dot badge-primary mr-10"></span>First
                                Time</h5>
                            <h5 class="my-0"><span class="badge badge-xl badge-dot badge-danger mr-10"></span>Returning
                            </h5>
                        </div>
                    </div>
                </div>
