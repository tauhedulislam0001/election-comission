...
class CreateSingleTripBookingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('single_trip_bookings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('single_trip_bookings');
    }
}
