...
class CreatePGNagadSuccessLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('p_g_nagad_success_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('p_g_nagad_success_logs');
    }
}
